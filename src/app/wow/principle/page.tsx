    ...
    <div>
      ...
      <section className="wow-principle__section" style={{ width: '100vw', position: 'relative', left: '50%', right: '50%', marginLeft: '-50vw', marginRight: '-50vw' }}>
        ...
        <div className="wow-principle__overlay-standard">
          ...
          <p>비오드의 사명은 올바른 기술과 원칙을 가지고 소비자가 더 바른 소비 판단을 할 수 있게 돕는 것입니다.
          ...
          <p>비오드는 누구보다 과학적인 데이터에 근거한 기술과 결과물 만을 신뢰합니다. 통념적이고 일반적인 정보에 의지하지 않고 철저히 우리의 연구와 실험을 통해 증명된 결과만을 믿습니다. 비오드가 만든 제품 앞에서 그 어떤 의심이나 고민도 필요하지 않은 이유입니다.</p>
          </div>
          <div>
          <p className="wow-principle__standard-text">|  효과를 확실하게 증명합니다.</p>
          <p>사실이 아닌 결과나 충족되지 않는 품질로 소비자를 유린하는 행위는 결코 용납되어서는 안됩니다. 누군가의 소중한 반려동물, 가족들이 먹는 제품의 특성상 그 어떤 제품보다 더욱 신뢰할 수 있는 시험자료와 성적서가 필요합니다. 효과가 입증될 수 없으면 만들지 않겠다는 비오드만의 고집입니다.</p>
          </div>
        </div>
      </section>
    </div>
