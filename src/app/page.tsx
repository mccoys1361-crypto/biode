...
const faqItems = [
  ...
  {
    question: "비오드 유산균은 일반 유산균과 무엇이 다른가요?",
    answer: "비오드는 1세대 유산균을 넘어선 2세대 유산균입니다. 장 건강만을 목표로 한 기존 유산균과 달리, 장 건강은 물론 면역력 강화, 체지방 감소, 건강수명 연장까지 복합적으로 케어합니다. DANISCO 17종 고기능 혼합 유산균과 특허받은 항비만 균주를 복합 배합한 프리미엄 솔루션입니다.",
  },
  {
    question: "항비만유산균이란 무엇인가요?",
    answer: "항비만유산균은 체지방 축적을 억제하는 기능을 가진 유산균입니다. 비오드에 함유된 락토바실러스 퍼멘텀 MG4231과 MG4244는 미국 특허 등록을 완료한 항비만 기능 균주로, 근육량은 유지하면서 체지방만 선택적으로 감소시키는 효과가 임상으로 증명되었습니다.",
  },
  {
    question: "비오드 유산균은 어떤 성분으로 만들어지나요?",
    answer: "비오드는 세계적 원료사 DANISCO의 17종 고기능 혼합 유산균, 특허받은 항비만 균주 락토바실러스 퍼멘텀, 검증된 유산균 복합체 IP0301을 사용합니다. 프리미엄 복합 유산균 2000억 CFU를 함유하며, SP 복합 코팅 기술로 유산균이 장까지 살아서 도달합니다.",
  },
];
...
export default function BIODEHomePage() {
  return (
    <div className="biode-home" style={{ backgroundColor: '#ffffff' }}>
      ...
      {/* 라이트핏 펫 유산균 제품 소개 */}
      <section className="biode-intro">
        <h2 style={{ textAlign: 'center', marginBottom: '1.5rem' }}>라이트핏 펫 유산균 - 비오드의 대표 제품</h2>
        <div className="biode-intro__grid">
          <div className="biode-intro__card">
            <h3>강아지유산균 &middot; 고양이유산균</h3>
            <p>비오드 라이트핏 펫 유산균은 강아지유산균과 고양이유산균을 하나로 통합한 제품입니다. 반려견과 반려묘 모두에게 안전하게 급여할 수 있도록 설계되었으며, HUMAN GRADE 등급 원료만을 사용합니다. 하루 한 포, 사료나 간식에 섞어 간편하게 급여하세요.</p>
          </div>
          <div className="biode-intro__card">
            <h3>항비만유산균 &middot; 다이어트 유산균</h3>
            <p>비오드에 함유된 락토바실러스 퍼멘텀은 미국 특허 등록을 완료한 항비만유산균입니다. 다이어트강아지유산균, 다이어트고양이유산균으로서 체지방 축적을 억제하고 건강한 체중 관리를 돕습니다. 근육량은 유지하면서 체지방만 선택적으로 감소시키는 과학적 설계입니다.</p>
          </div>
          <div className="biode-intro__card">
            <h3>프리미엄 복합 유산균 2000억 CFU</h3>
            <p>세계적 원료사 DANISCO의 17종 고기능 혼합 유산균과 AF균주유산균을 복합 배합했습니다. SP 복합 코팅 기술로 유산균이 위산을 견디고 장까지 살아서 도달합니다. 강아지영양제, 고양이영양제로서 장 건강, 면역력 강화, 체지방 관리까지 종합적으로 케어합니다.</p>
          </div>
        </div>
      </section>
      ...
      {/* 비오드를 선택하는 이유 */}
      <section className="biode-intro" style={{ paddingTop: 0 }}>
        <h2 style={{ textAlign: 'center', marginBottom: '1.5rem' }}>반려동물유산균, 비오드를 선택하는 이유</h2>
        <div className="biode-intro__grid">
          <div className="biode-intro__card">
            <h3>안전한 원료</h3>
            <p>사람이 먹을 수 있는 HUMAN GRADE 등급 원료만 사용합니다. 엄마의 눈으로 성분 하나하나까지 꼼꼼하게 따져 만든 반려동물유산균입니다. 반려견유산균, 반려묘유산균의 새로운 안전 기준을 세웁니다.</p>
          </div>
          <div className="biode-intro__card">
            <h3>과학적으로 검증된 효과</h3>
            <p>비오드의 모든 효과는 임상 데이터로 증명됩니다. 체지방량 변화, 체지방률 변화를 임상 시험으로 확인했습니다. 막연한 기대가 아닌, 숫자가 말해주는 확실한 변화를 제공하는 반려동물 영양제입니다.</p>
          </div>
          <div className="biode-intro__card">
            <h3>1개월 환불 보장</h3>
            <p>비오드는 제품에 자신이 있습니다. 구매 후 1개월 이내 만족하지 못하시면 환불해 드립니다. 과도한 광고비 대신 고객에게 그 비용을 돌려드리는 소비자 광고비 지원정책도 운영하고 있습니다.</p>
          </div>
        </div>
      </section>
