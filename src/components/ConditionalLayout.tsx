          ...
          <div className="biode-footer__container">
            ...
            <div className="biode-footer__info">
              ...
              <div className="biode-footer__info-row">
                ...
                <span className="biode-footer__text">안동진</span>
              </div>
              <div className="biode-footer__info-row">
            ...
            <div className="biode-footer__social">
              <a href="https://www.instagram.com/biode_official" target="_blank" rel="noopener noreferrer" className="biode-footer__social-icon" aria-label="비오드 인스타그램">
