...
export const SEO_CONFIG = {
  ...
  portal: {
    ...
    url: "https://www.biode.com/portal",
    image: "/portal-og.jpg",
  ...
  pages: {
    home: {
      title: "홈 - 비오드(BIODE)",
      description:
        "비오드(BIODE) 홈페이지 - 친환경 비닐 제작업체, 지속가능한 농업 솔루션",
      keywords: [
        "홈",
        "메인",
        "친환경 비닐",
...
export const STRUCTURED_DATA_CONFIG = {
  organization: {
    biode: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://www.biode.com/logo.png",
        width: 200,
        height: 60,
      },
      address: {
      ...
      foundingDate: "2020",
      industry: "농업용품 제조업",
      keywords: "비오드, BIODE, 친환경 비닐, 농업, 지속가능, 환경보호",
      inLanguage: "ko-KR",
    },
  },
  website: {
    biode: {
      ...
      potentialAction: {
        "@type": "SearchAction",
        target: "https://www.biode.com/search?q={search_term_string}",
      ...
      itemListElement: [
        {
          ...
          position: 1,
          name: "홈",
          item: "https://www.biode.com",
        },
        {
          "@type": "ListItem",
          position: 2,
          name: "공지사항",
          item: "https://www.biode.com/notice",
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "문의하기",
          item: "https://www.biode.com/inquiry",
        },
      ],
    },
  },
