...
export const SEO_CONFIG = {
  ...
  portal: {
    ...
    url: "https://www.biode.co.kr/portal",
    image: "/portal-og.jpg",
...
export const STRUCTURED_DATA_CONFIG = {
  organization: {
    biode: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://www.biode.co.kr/logo.png",
        width: 200,
        height: 60,
      },
      address: {
  ...
  website: {
    biode: {
      ...
      potentialAction: {
        "@type": "SearchAction",
        target: "https://www.biode.co.kr/search?q={search_term_string}",
      ...
      itemListElement: [
        {
          ...
          position: 1,
          name: "홈",
          item: "https://www.biode.co.kr",
        },
        {
          "@type": "ListItem",
          position: 2,
          name: "공지사항",
          item: "https://www.biode.co.kr/notice",
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "문의하기",
          item: "https://www.biode.co.kr/inquiry",
        },
      ],
    },
  },
  article: {
    notice: {
      ...
      mainEntityOfPage: {
        "@type": "WebPage",
        "@id": "https://www.biode.co.kr/notice",
      },
    },
  },
};
